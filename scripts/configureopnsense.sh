...
#fetch https://raw.githubusercontent.com/annduy/opnazure/dev_active_active/scripts/$1
#fetch https://raw.githubusercontent.com/annduy/opnazure/master/scripts/$1
